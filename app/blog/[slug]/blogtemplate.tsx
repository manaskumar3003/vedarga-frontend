...
const Blogtemplate: React.FC<BlogtemplateProps> = ({ title, content,imageUrl }) => {
    ...
    <div className   ="lg:col-span-2">
      <div className   ="py-8 lg:pe-8">
        <div className   ="space-y-5 lg:space-y-8">
          <a className   ="inline-flex items-center gap-x-1.5 text-sm text-gray-600 decoration-2 hover:underline dark:text-blue-500" href="#">
          ...
          <h2 className   ="text-3xl font-bold lg:text-5xl dark:text-white">{title}</h2>
          ...
          <div className   ="space-y-3">
            ...
            <p className   ="text-lg text-gray-800 dark:text-neutral-200">{content}</p>
          </div>
