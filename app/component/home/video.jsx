...
const Video = () => {
  ...
  return (
    <section className="flex items-center justify-center
     py-20 dark:bg-dark lg:py-[120px]">
            ...
            <div className="relative z-20 h-[300px] overflow-hidden rounded-lg md:h-[450px]">
              ...
              >
                <a
                  ...
                  className="absolute z-20 flex h-20 w-20 items-center justify-center rounded-full  text-primary dark:bg-dark-2 dark:text-white md:h-[100px] md:w-[100px]"
                >
                  <span className="absolute right-0 top-0 z-[-1] h-full w-full animate-ping rounded-full  bg-opacity-20 delay-300 duration-1000"></span>
                  <svg
                    width="23"
                    height="27"
                    viewBox="0 0 23 27"
