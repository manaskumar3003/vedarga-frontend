...
const Sidebar = ({ setPage }:{setPage:any}) => {
  ...
  return (
    ...
    <div>
      ...
      <div className="w-8 ml-4 h-screen bg-gray-100 rounded-lg flex flex-col items-center">
        <div className="pb-5 pt-5">
          <svg className="w-10 h-8 outline-gray-300 bg-blue-600 outline my-3 rounded-2xl text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="red  " viewBox="0 0 24 24">
              <path stroke="orange" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M18.122 17.645a7.185 7.185 0 0 1-2.656 2.495 7.06 7.06 0 0 1-3.52.853 6.617 6.617 0 0 1-3.306-.718 6.73 6.73 0 0 1-2.54-2.266c-2.672-4.57.287-8.846.887-9.668A4.448 4.448 0 0 0 8.07 6.31 4.49 4.49 0 0 0 7.997 4c1.284.965 6.43 3.258 5.525 10.631 1.496-1.136 2.7-3.046 2.846-6.216 1.43 1.061 3.985 5.462 1.754 9.23Z"/>
          </svg>

        </div>
        <div>
          <hr className="h-px my-2 bg-red-900 border-0 dark:bg-gray-700" />
        </div>
        <div>
          <button onClick={() => setPage('Dashboard')}  className="bg-gray-200 my-3 h-8 w-10 rounded-md hover:bg-blue-200 flex items-center justify-center" title="Dashboard">
        ...
        <div>
            <button onClick={() => setPage('task')} className="my-3 bg-gray-200 h-8 w-10 rounded-md hover:bg-green-200 flex items-center justify-center" title='task'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
        ...
        <div>
            <button onClick={() => setPage('AI')} className="my-3 bg-gray-200 h-8 w-10 rounded-md hover:bg-green-200 flex items-center justify-center" title='AI'>
            <svg xmlns="http://www.w3.org/2000/svg" className="size-6" x="0px" y="0px" width="100" height="100" viewBox="0 0 30 30">
        ...
        <div>
            <button onClick={() => setPage('orders')} className="my-3 bg-gray-200 h-8 w-10 rounded-md hover:bg-green-200 flex items-center justify-center" title='orders'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
        ...
        <div>
            <button onClick={() => setPage('helpdesk')} className="my-3 bg-gray-200 h-8 w-10 rounded-md hover:bg-orange-200 flex items-center justify-center" title='helpdesk'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
        ...
        <div>
            ...
            <path stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M5 19V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v13H7a2 2 0 0 0-2 2Zm0 0a2 2 0 0 0 2 2h12M9 3v14m7 0v4"/>
            </svg>
            </button>
        </div>
        ...
        <div>
            <button onClick={() => setPage('helpdesk')} className="my-3 bg-gray-200 h-8 w-10 rounded-md hover:bg-orange-200 flex items-center justify-center" title='helpdesk'>
            <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M4 13h3.439a.991.991 0 0 1 .908.6 3.978 3.978 0 0 0 7.306 0 .99.99 0 0 1 .908-.6H20M4 13v6a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-6M4 13l2-9h12l2 9M9 7h6m-7 3h8"/>
            </svg>
            </button>
        </div>
        ...
        <div>
            <button onClick={() => setPage('setting')} className="mt-3 bg-gray-200 h-8 w-10 rounded-lg hover:bg-red-200 flex items-center justify-center">
              <svg className="w-6 h-6  " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24">
                  <path stroke="black " strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M21 13v-2a1 1 0 0 0-1-1h-.757l-.707-1.707.535-.536a1 1 0 0 0 0-1.414l-1.414-1.414a1 1 0 0 0-1.414 0l-.536.535L14 4.757V4a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v.757l-1.707.707-.536-.535a1 1 0 0 0-1.414 0L4.929 6.343a1 1 0 0 0 0 1.414l.536.536L4.757 10H4a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h.757l.707 1.707-.535.536a1 1 0 0 0 0 1.414l1.414 1.414a1 1 0 0 0 1.414 0l.536-.535 1.707.707V20a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-.757l1.707-.708.536.536a1 1 0 0 0 1.414 0l1.414-1.414a1 1 0 0 0 0-1.414l-.535-.536.707-1.707H20a1 1 0 0 0 1-1Z"/>
                  <path stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/>
              </svg>
            </button>
